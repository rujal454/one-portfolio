  ...
  return (
    ...
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white text-center md:text-left mt-12 sm:mt-0">
          ...
          <div>
            <Link
              ...
              smooth
              duration={500}
              className="group text-white w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-gray-700 to-blue-500 cursor-pointer"
            >
              Portfolio
